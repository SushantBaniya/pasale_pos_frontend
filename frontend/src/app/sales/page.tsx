        ...
        <div className="relative px-6 py-6 sm:px-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1 font-medium">
                  Track retail checkouts, corporate accounts, credit balances, and POS entries
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              >
                <FiPlus size={15} /> Create Sales Invoice
              </button>
            </div>
      ...
      <div className="flex flex-wrap items-center gap-3 bg-white dark:bg-[#15161C] p-3 rounded-xl border border-[#E2E8F0] dark:border-[#2A2B36] shadow-sm mb-6">
        <div className="relative flex-1 min-w-[240px]">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 border border-[#E2E8F0] dark:border-[#2A2B36] rounded-lg bg-white dark:bg-[#1C1D24] text-[13px] text-slate-800 dark:text-[#EAE5DF] placeholder-slate-400 focus:outline-none"
          />
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-white dark:bg-[#1C1D24] border-b border-[#E2E8F0] dark:border-[#2A2B36]">
                ...
                <th className="py-4 px-6 text-[11px] font-bold text-[#94A3B8] uppercase tracking-wider">INVOICE NO</th>
              ...
              {loading ? (
                <tr>
                  <td colSpan={6} className="py-16 text-center">
                    ...
                    <p className="text-xs text-slate-400">Loading sales invoices...</p>
                  </td>
                </tr>
              ) : filtered.length === 0 ? (
                <tr>
                  <td colSpan={6} className="py-16 text-center">
                    <p className="text-sm font-bold text-slate-400 mb-3">No sales invoices found</p>
                    <button
                      onClick={() => navigate('/sales/new')}
