  ...
  return (
    <div className="max-w-[900px] mx-auto pb-10 mt-6 px-4">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-xl font-bold text-slate-800 dark:text-[#EAE5DF]">Create Sales Invoice</h1>
          <p className="text-xs text-slate-400 mt-0.5">Generate a custom tax invoice or standard cash memo for checkout</p>
        </div>
      </div>
